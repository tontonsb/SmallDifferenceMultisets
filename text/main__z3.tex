...
% \subsubsection{Estimating numbers}
...
% 	\end{equation}
% 	
% 	where $p_i$ are primes such that $p_i \equiv 1 \pmod 3$ and $q_i$ are primes such that $q_i \equiv 2 \pmod 3$. If any of the $\beta_i$ are odd, there are no integer solutions to $k=a^2+ab+b^2$. But if all of $\beta_i$ are even, the number of solutions is $6\prod (\alpha_i +1)$.
% 	
